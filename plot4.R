...
filtered_data$timestamp <- strptime(paste(filtered_data$Date,filtered_data$Time, 
...
plot(filtered_data$timestamp,as.numeric(filtered_data$Voltage),
     main="",
     xlab="datetime", ylab="Voltage", type="l",col="orange")

plot(filtered_data$timestamp,as.numeric(filtered_data$Global_reactive_power),
     main="",
     xlab="datetime", ylab="Global_reactive_power", type="l",col="brown")
